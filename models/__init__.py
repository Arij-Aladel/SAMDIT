...
try:
    ...
    raise ImportError(
        "Using t5mem requires torch. Please refer to https://pytorch.org/get-started/locally/ "
...
# __all__ = ['configuration_t5mem', 'modeling_t5mem','tokenization_t5mem_fast', 'tokenization_t5mem']
...
AutoTokenizer.register(
    ...
    fast_tokenizer_class=T5MemTokenizerFast,
)
